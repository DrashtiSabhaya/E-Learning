...
<nav class="navbar navbar-expand-md">
    ...
    <li class="nav-item">
        ...
        <li class="nav-item">
        <a class="nav-link" href="create_class.jsp">Create Class</a>
        </li>
        <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Add Content</a>
        <div class="dropdown-menu">
            <a class="dropdown-item font" href="add_video.jsp">Add Video</a>
            <a class="dropdown-item font" href="add_content.jsp">Add Material</a>
        </div>
        </li>
        <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Assignment</a>
        <div class="dropdown-menu">
            <a class="dropdown-item font" href="assignment.jsp">Add Assignments</a>
